            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text("Biometrics Enabled", style: header2.copyWith(color: ANColor.backgroundText),),
                  Transform.scale(
                    scale: 1.4,
                    child: Switch(
                      ...
                      activeTrackColor: Color(0xFF1EBD71).withOpacity(0.5),
                      activeColor: Color(0xFF1EBD71),
                    ),
                  )
